...
@section('content')
    ...
    <section class="main" style="margin-top: 4rem;">
        ...
        <h1 class="text-white text-center fs30" style="margin-bottom: 2em;">My Favorites Gradients</h1>
                    ...
                    <div class="gradient_content">
                        <div class="gradient_content_header">
                            ...
                            <div class="flex flex-middle">
                                <svg class="favs_add__btn" data-id="<?= $gradient['gradient_id'] ?>" style="fill: <?= $hasColor ?>" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                    <path d="M12 .288l2.833 8.718h9.167l-7.417 5.389 2.833 8.718-7.416-5.388-7.417 5.388 2.833-8.718-7.416-5.389h9.167z"/>
                                </svg>
                                &nbsp;<span><?= $favsCount[$gradient['gradient_id']] ?? 0 ?></span>
                            </div>
                            <a class="btn" href="{{ route('gradient', ['id' => $gradient['gradient_id']]) }}">
