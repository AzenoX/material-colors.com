...
@section('content')
    ...
    <section class="main">
        ...
        <div class="flex flex-sparound flex-middle">
            ...
            <div class="w40 home_wrappers flex flex-col flex-cent preview_wrapper">
                <div>
                        ...
                        <div class="selected__wrapper__body">
                            <div class="selected__wrapper__body__table shadowed">
                                <table>
                                    <tr>
                                        <td>
                                            <p><span class="selected__body__table__text_hex">#ffffff</span><span class="selected__body__table__text__copy selected__body__table__text__copy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 4h-20v20h20v-20zm-24 17v-21h21v2h-19v19h-2z"/></svg></span></p>

                                        </td>
                                        <td>
                                            <p><span class="selected__body__table__text_hexa">#ffffffFF</span><span class="selected__body__table__text__copy selected__body__table__text__copy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 4h-20v20h20v-20zm-24 17v-21h21v2h-19v19h-2z"/></svg></span></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><span class="selected__body__table__text_rgb">rgb(255,205,210)</span><span class="selected__body__table__text__copy selected__body__table__text__copy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 4h-20v20h20v-20zm-24 17v-21h21v2h-19v19h-2z"/></svg></span></p>
                                        </td>
                                        <td>
                                            <p><span class="selected__body__table__text_rgba">rgba(255,205,210,1)</span><span class="selected__body__table__text__copy selected__body__table__text__copy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 4h-20v20h20v-20zm-24 17v-21h21v2h-19v19h-2z"/></svg></span></p>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <p><span class="selected__body__table__text_hsl">hsl(354,100%,90.2%)</span><span class="selected__body__table__text__copy selected__body__table__text__copy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 4h-20v20h20v-20zm-24 17v-21h21v2h-19v19h-2z"/></svg></span></p>
                                        </td>
                                        <td>
                                            <p><span class="selected__body__table__text_hsla">hsla(354,100%,90.2%,100%)</span><span class="selected__body__table__text__copy selected__body__table__text__copy"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M24 4h-20v20h20v-20zm-24 17v-21h21v2h-19v19h-2z"/></svg></span></p>
                                        </td>
                                    </tr>
                                </table>
                            </div>
